...
export const summaryTex2 = {
  ...
  text: "El reconocimiento y desbloqueo emocional se lleva a cabo a través de la aplicación de conceptos que he seleccionado de siete teorías en combinación con el uso de aceites esenciales.",
};
export const summaryTex3 = {
  icon: "mail-outline",
  text: "Ponte en contacto con nosotros para cualquier duda y/o tener una mejor comprension de las cartas y teorias.",
};
